...
**Pattern observation:** Graffiti requests show clear spatial clustering across Chicago, indicating they follow neighborhood-level patterns similar to burglary.
...
**Why this step is important:** Standardizing coordinate systems and exploring raw spatial patterns ensures accurate later analysis and verifies that graffiti provides meaningful spatial variation for burglary prediction.

**What I learned:** Both burglary and graffiti exhibit strong spatial clustering, confirming that neighborhood context matters and supporting graffiti’s use as a predictor in the fishnet modeling step.
...
**Distribution characteristics:** Burglary counts across grid cells are heavily right-skewed, with most cells having 0–2 incidents and a small number forming a long high-count tail typical of crime data.
...
**Why this step is important:** Using a uniform grid provides consistent spatial units for regression, reduces point-level noise, and reveals distributional patterns needed to choose appropriate count models.

**What I learned:** Burglary remains highly clustered even after aggregation, with many zero-count cells and a few extreme hotspots, reinforcing the need for Poisson or Negative Binomial modeling.
...
**Why this step is important:** KDE provides a fundamental benchmark by capturing where crime has historically concentrated, and any advanced model must surpass this baseline while leveraging additional predictors.

**What I learned:** The KDE surface reveals broad, coherent hotspots and strong spatial autocorrelation, confirming spatial structure in burglary risk and the need for models that combine local indicators with large-scale spatial trends.
...
**Why this step is important:** These steps generate key predictors—graffiti intensity, proximity, and hotspots—that capture different dimensions of neighborhood disorder relevant for explaining burglary patterns.

**What I learned:** Graffiti is highly uneven and clustered, often overlapping with burglary hotspots, and its intensity, proximity, and hotspot features appear useful for predicting burglary risk.
