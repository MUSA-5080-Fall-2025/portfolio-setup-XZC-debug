...
- What coordinate reference system is each dataset in?- CRS (counties): EPSG:5070
...
- **Healthcare Accessibility:** Most census tracts in Pennsylvania have relatively short distances to the nearest hospital, especially in the eastern and southeastern regions around major cities such as Philadelphia, Pittsburgh, and Harrisburg.
However, several rural counties in the north and central parts of the state show noticeably longer travel distances (over 30–50 km), indicating potential healthcare access challenges.
- **Social Vulnerability::** Tract-level vulnerability (composite z-score) reveals higher vulnerability in parts of western and northern Pennsylvania, where lower median incomes, higher poverty rates, and a larger elderly population coincide.
Urban tracts generally show lower vulnerability due to higher incomes and better transportation access.
- **County-Level Aggregation:** When aggregated to the county scale, vulnerability differences become less pronounced—many counties show similar average scores—suggesting that county-level averages may mask substantial intra-county disparities present at the tract level.
In contrast, county-level minimum hospital distance still highlights clear regional inequities, particularly across sparsely populated northern counties.
