...
required_pkgs <- c(
"tidyverse","sf","tigris","tidycensus","units","janitor"
)
...
analysis_crs <- 26918 # NAD83 / UTM zone 18N

# Load spatial data
pa_counties <- tigris::counties(state = state_abbr, year = 2022, cb = TRUE) |>
st_as_sf() |>
janitor::clean_names()

pa_tracts <- tidycensus::get_acs(
geography = "tract",
state = state_abbr,
year = 2022,
survey = "acs5",
